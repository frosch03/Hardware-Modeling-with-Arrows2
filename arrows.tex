...
The \hs{Grid}-Arrow is a combination of an executable arrow and a descriptive hardware component part. In a first approach one can imagine the descriptive part to live inside the arrow. But that does not 
They are stored equally to
each other inside a tuple. The arrow resides in the first, the graph occupies the second part of the tuple.
\begin{haskell}
